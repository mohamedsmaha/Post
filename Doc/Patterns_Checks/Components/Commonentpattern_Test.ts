...
export const Tests: { [key in Components_Name]: ComponentPattern_Check } = {
    ...
    Comment             : { Design: 0, Code: 0, Info: 0, Lang: 0, Types: 0 , Finish : false },
    Delete_Card         : { Design: 0, Code: 0, Info: 0, Lang: 0, Types: 0 , Finish : false },
    ...
    PostForm            : { Design: 5, Code: 5, Info: 0, Lang: 0, Types: 4 , Finish : false },
    PostCommentsBox     : { Design: 0, Code: 0, Info: 0, Lang: 2, Types: 0 , Finish : false },
